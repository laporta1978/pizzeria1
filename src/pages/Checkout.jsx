...
import { ArrowLeft, MapPin, Phone, User, Mail, MessageSquare, Truck, Store, CheckCircle } from 'lucide-react';
...
export default function Checkout() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Pedido registrado localmente (podés conectar Firestore aquí en el futuro)
    ...
    // Descontar stock de cada producto en Firestore
    ...
    // Refrescar para que los componentes vean el stock actualizado
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`p-4 rounded-xl border-2 flex items-center gap-3 transition-all ${
                      deliveryMethod === 'delivery' ? 'border-primary bg-primary/10' : 'border-border hover:border-muted-foreground/30'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border-2 flex items-center gap-3 transition-all ${
                      deliveryMethod === 'pickup' ? 'border-primary bg-primary/10' : 'border-border hover:border-muted-foreground/30'
                    }`}
                  >
